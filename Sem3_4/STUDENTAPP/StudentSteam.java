...
/*
 * Интерфейс Iterable был реализован, поэтому в классе StudentStream былреализован 
 * метод iterator(), 
...
/*
 * Класс StudentGroup представляет учебную группу и содержит поля name -
 * название группы и numberOfStudents - количество студентов в группе.
 */
